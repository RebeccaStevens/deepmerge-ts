...
export function deepmergeInto<Target extends object, Ts extends ReadonlyArray<unknown>>(
  ...
  Target & DeepMergeHKT<[Target, ...Ts], DeepMergeFunctionsDefaultURIs, DeepMergeMetaMetaData>
>;
...
export function deepmergeIntoCustom<BaseTs = unknown>(
  options: DeepMergeIntoOptions<DeepMergeMetaMetaData, DeepMergeMetaMetaData>,
...
export function deepmergeIntoCustom<
  BaseTs = unknown,
  MetaData = DeepMergeMetaMetaData,
...
export function deepmergeIntoCustom<BaseTs, MetaData, MetaMetaData extends DeepMergeMetaMetaData>(
  options: DeepMergeIntoOptions<MetaData, MetaMetaData>,
  rootMetaData?: MetaData,
): <Target extends object, Ts extends ReadonlyArray<BaseTs>>(target: Target, ...objects: Ts) => void {
  /**
 ...
 */
function getIntoUtils<M, MM extends DeepMergeMetaMetaData = DeepMergeMetaMetaData>(
